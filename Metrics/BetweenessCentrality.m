%% Calculate Betweeness Centrality Coefficients, node and edge wise, for a set
% of graphs
%
%
%  ARGUMENTS:
%    x[nodes,nodes,noepochs] -- A 3-D array of noepochs connectivity matricies.
%                               Edges are expected to represent weights, ie., 
%                               larger value = stronger connection, rather than
%                               distances.
%
%
%  OUTPUTS:
...
%
% REQUIRES: 
%          BCwei() -- Betweenness centrality for a weighted graph.
%
% USAGE:
%{
...
function [Hubco nodeHubco stdnodeHubco Edgco edgEdgco stdedgEdgco        ...
          epochHubco stdepochHubco epochwiseHub epochEdgco stdepochEdgco ...
          epochwiseEdg] = BetweenessCentrality(x)
