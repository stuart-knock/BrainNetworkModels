%% Calculate Weigthted Degrees (In, Out, and Total), mean, node-wise, and epoch-wise. 
%
...
function [In Out stdIn stdOut nodeIn stdnodeIn nodeOut stdnodeOut epochIn stdepochIn epochOut stdepochOut] = Degrees(x)
